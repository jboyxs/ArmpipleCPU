...
namespace eval ::optrace {
  variable script "C:/Users/jjboy/ArmPipleCPU/ArmPipleCPU.runs/synth_1/Multiplev2.tcl"
...
read_verilog -library xil_defaultlib {
  ...
  C:/Users/jjboy/ArmPipleCPU/ArmPipleCPU.srcs/sources_1/new/Multiplev2.v
}
...
synth_design -top Multiplev2 -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef Multiplev2.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file Multiplev2_utilization_synth.rpt -pb Multiplev2_utilization_synth.pb"  } 
