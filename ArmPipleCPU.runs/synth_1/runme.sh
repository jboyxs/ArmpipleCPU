...
HD_PWD='C:/Users/jjboy/ArmPipleCPU/ArmPipleCPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiplev2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Multiplev2.tcl
