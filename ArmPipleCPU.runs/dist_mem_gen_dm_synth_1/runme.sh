...
HD_PWD='C:/Users/jjboy/ArmPipleCPU/ArmPipleCPU.runs/dist_mem_gen_dm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dist_mem_gen_dm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dist_mem_gen_dm.tcl
