...
HD_PWD='C:/Users/jjboy/ArmPipleCPU/ArmPipleCPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiplev2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Multiplev2.tcl -notrace
