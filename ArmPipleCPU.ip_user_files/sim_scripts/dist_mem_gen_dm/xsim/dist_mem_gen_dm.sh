...
#
# Script generated by Vivado on Sat Jun 21 15:10:42 +0800 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dist_mem_gen_dm.sh
...
#
# Usage        : dist_mem_gen_dm.sh
#                dist_mem_gen_dm.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dist_mem_gen_dm.sh [-reset_run]
#                dist_mem_gen_dm.sh [-reset_log]
#                dist_mem_gen_dm.sh [-help]
#
...
# script info
echo -e "dist_mem_gen_dm.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dist_mem_gen_dm.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L dist_mem_gen_v8_0_15 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dist_mem_gen_dm xil_defaultlib.dist_mem_gen_dm xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dist_mem_gen_dm -key {Behavioral:sim_1:Functional:dist_mem_gen_dm} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dist_mem_gen_dm.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dist_mem_gen_dm.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dist_mem_gen_dm.sh [-help]\n\
Usage: dist_mem_gen_dm.sh [-step]\n\
Usage: dist_mem_gen_dm.sh [-lib_map_path]\n\
Usage: dist_mem_gen_dm.sh [-reset_run]\n\
Usage: dist_mem_gen_dm.sh [-reset_log]\n\
Usage: dist_mem_gen_dm.sh [-keep_index]\n\
Usage: dist_mem_gen_dm.sh [-noclean_files]\n\n\
