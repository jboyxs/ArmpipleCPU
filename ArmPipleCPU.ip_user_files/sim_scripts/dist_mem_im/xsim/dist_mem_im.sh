...
#
# Script generated by Vivado on Sat Jun 21 00:39:45 +0800 2025
...
#
# Usage        : dist_mem_im.sh
#                dist_mem_im.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dist_mem_im.sh [-reset_run]
#                dist_mem_im.sh [-reset_log]
#                dist_mem_im.sh [-help]
#
...
# script info
echo -e "dist_mem_im.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dist_mem_im.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L dist_mem_gen_v8_0_15 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dist_mem_im xil_defaultlib.dist_mem_im xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dist_mem_im.wdb xsim.dir libdpi.so)
...
Usage: dist_mem_im.sh [-step]\n\
Usage: dist_mem_im.sh [-lib_map_path]\n\
Usage: dist_mem_im.sh [-reset_run]\n\
Usage: dist_mem_im.sh [-reset_log]\n\
Usage: dist_mem_im.sh [-keep_index]\n\
